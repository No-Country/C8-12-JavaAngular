...
@Component({
  selector: 'app-appt-patient',
  templateUrl: './appt-patient.component.html',
  styleUrls: ['./appt-patient.component.css']
})
export class ApptPatientComponent implements OnInit {
